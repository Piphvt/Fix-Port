                ...
                <div>
                    <v-menu bottom right :offset-y="true" :nudge-top="8" :nudge-right="8" class="user-menu">
                        ...
                        <v-list class="custom-list">
                            <v-list-item @click="SummarizeStockDataOpen = true"
                                v-if="$auth.user.rank_no === 1 || $auth.user.rank_no === 3" class="custom-list-item">
                                <v-list-item-icon style="margin-right: 5px;">
                                    <v-icon class="icon-tab" color="#ffc800">mdi-account-hard-hat</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                            ...
                            <v-list-item @click="SoldOutStockDataOpen = true" class="custom-list-item">
                                <v-list-item-icon style="margin-right: 5px;">
                                    <v-icon class="icon-tab" color="#85d7df">mdi-piggy-bank</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                                    <v-list-item-title style="font-size: 0.8rem;">ขายหมดแล้ว</v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
